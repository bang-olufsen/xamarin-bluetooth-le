...
namespace Plugin.BLE.Abstractions.Contracts
{
    ...
    public interface IAdapter
    {
        ...
        /// </summary>
        Task<IDevice> ConnectAsync(Guid uuid, Func<IDevice, bool> deviceFilter, CancellationToken cancellationToken = default(CancellationToken));        /// Returns a list of paired BLE devices for the given UUIDs.
